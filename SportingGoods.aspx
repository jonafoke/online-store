<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SportingGoods.aspx.cs" Inherits="Assignment_3.WebForm4" %>
...
<div class ="wrapper">    
        ...
        <asp:DataList ID="dlSportingGoods" runat="server" RepeatColumns="2" Width="950px" OnItemCommand="dlSportingGoods_ItemCommand" OnSelectedIndexChanged="dlSportingGoods_SelectedIndexChanged">
