<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Footwear.aspx.cs" Inherits="Assignment_3.WebForm2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <link href="gallerised/styles/tables.css" rel="stylesheet" />
        ...
        <div class ="wrapper">    
        <h1>Footwear</h1>
        <asp:DataList ID="dlFootwear" runat="server" RepeatColumns="2" Width="950px" OnItemCommand="dlFootwear_ItemCommand" OnSelectedIndexChanged="dlFootwear_SelectedIndexChanged">
